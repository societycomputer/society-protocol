      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Latent Space (Inner Thoughts)', slug: 'concepts/latent-space' },
          ],
        },
        {
          label: 'Guides',
          items: [
            ...
            { label: 'Skills & Capabilities', slug: 'guides/skills-system' },
